...
public class UsuarioServiceApiApi {
     ...
     */
    public okhttp3.Call consultarFechasCall(Long idUser, Integer anioCurso, String evaluacion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call consultarFechasValidateBeforeCall(Long idUser, Integer anioCurso, String evaluacion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'idUser' is set
        if (idUser == null) {
        ...
        return consultarFechasCall(idUser, anioCurso, evaluacion, _callback);
     ...
     */
    public List<FechaPractica> consultarFechas(Long idUser, Integer anioCurso, String evaluacion) throws ApiException {
        ApiResponse<List<FechaPractica>> localVarResp = consultarFechasWithHttpInfo(idUser, anioCurso, evaluacion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<FechaPractica>> consultarFechasWithHttpInfo(Long idUser, Integer anioCurso, String evaluacion) throws ApiException {
        okhttp3.Call localVarCall = consultarFechasValidateBeforeCall(idUser, anioCurso, evaluacion, null);
     ...
     */
    public okhttp3.Call consultarFechasAsync(Long idUser, Integer anioCurso, String evaluacion, final ApiCallback<List<FechaPractica>> _callback) throws ApiException {

        okhttp3.Call localVarCall = consultarFechasValidateBeforeCall(idUser, anioCurso, evaluacion, _callback);
        Type localVarReturnType = new TypeToken<List<FechaPractica>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
