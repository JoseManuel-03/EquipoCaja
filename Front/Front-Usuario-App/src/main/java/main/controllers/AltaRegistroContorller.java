...
public class AltaRegistroContorller extends AppController {
	...
	public void initialize() {
		...
		if (usuario != null) {
			...
			List<FechaPractica> fechasPracticas = apiService.obtenerFechasDisponibles(usuario.getId(), usuario.getAño(),
					usuario.getEvaluacion());

			List<LocalDate> fechasDisponibles = new ArrayList<LocalDate>();
			for (FechaPractica fechaPractica : fechasPracticas) {
				fechasDisponibles.add(fechaPractica.getFecha());
			}
	 ...
	 *         Este método debe ser implementado en ApiService return
	 *         apiService.obtenerFechasDisponibles(idUsuario); }
	 */
	/**
